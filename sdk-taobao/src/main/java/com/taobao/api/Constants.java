...
public abstract class Constants {
	...
	/** SDK版本号 */
	public static final String SDK_VERSION = "top-sdk-java-20201225";

	/** 异步多活SDK版本号 */
	public static final String SDK_VERSION_CLUSTER = "top-sdk-java-cluster-20201225";
	
	/** httpdns SDK版本号 */
    public static final String SDK_VERSION_HTTPDNS = "top-sdk-java-httpdns-20201225";
