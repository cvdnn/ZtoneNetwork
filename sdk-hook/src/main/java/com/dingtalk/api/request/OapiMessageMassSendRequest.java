...
public class OapiMessageMassSendRequest extends BaseTaobaoRequest<OapiMessageMassSendResponse> {
	...
	* 调用时填写随机生成的UUID, 防止消息重复发送
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 5567847114869352495L;
		/**
		 * 正整数，小于60，表示音频时长
		 */
		@ApiField("duration")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 6596331469245426316L;
		/**
	...
	public static class FormItem extends TaobaoObject {
		private static final long serialVersionUID = 1867315234153693948L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class RichText extends TaobaoObject {
		private static final long serialVersionUID = 6534423712592567115L;
		/**
		 * 单行富文本信息的数目
		 */
		@ApiField("num")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 1844497566329186292L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class OA extends TaobaoObject {
		private static final long serialVersionUID = 3772731581141359267L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 8717912172548986141L;
		/**
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 8635311544597578122L;
		/**
		 * 消息点击链接地址，当发送消息为小程序时支持小程序跳转链接
		 */
		@ApiField("message_url")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 2868743657847424921L;
		/**
	...
	public static class Button extends TaobaoObject {
		private static final long serialVersionUID = 3773827335395134218L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 4324189852849679942L;
		/**
	...
	public static class MessageBody extends TaobaoObject {
		private static final long serialVersionUID = 3438647617947773223L;
		/**
		 * action_card卡片消息
		 */
