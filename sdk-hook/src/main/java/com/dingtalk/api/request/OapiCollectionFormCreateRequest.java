...
public class OapiCollectionFormCreateRequest extends BaseTaobaoRequest<OapiCollectionFormCreateResponse> {
	...
	* 根请求
	...
	public static class ProcessVisibleValueVo extends TaobaoObject {
		private static final long serialVersionUID = 1311147924591314212L;
		/**
		 * 类型
		 */
	...
	public static class FormSchemaSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 7487732314457683163L;
		/**
		 * 业务类型
		 */
		@ApiField("biz_type")
	...
	public static class BehaviorTarget extends TaobaoObject {
		private static final long serialVersionUID = 1463293794259358235L;
		/**
		 * 行为
		 */
		@ApiField("behavior")
	...
	public static class BehaviorLinkageVo extends TaobaoObject {
		private static final long serialVersionUID = 8663572619446988128L;
		/**
		 * 选项级联目标
		 */
	...
	public static class ComponentPropOptionVo extends TaobaoObject {
		private static final long serialVersionUID = 5263685978948982922L;
		/**
		 * 名称
		 */
		@ApiField("key")
	...
	public static class ComponentMatrixDefVo extends TaobaoObject {
		private static final long serialVersionUID = 8464115593255982729L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 1173558484582289376L;
		/**
		 * 选项级联属性
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 3835112975616787562L;
		/**
		 * 控件名称
		 */
	...
	public static class FormContentVo extends TaobaoObject {
		private static final long serialVersionUID = 5149851663577857164L;
		/**
		 * 控件数组
		 */
		@ApiListField("items")
	...
	public static class SwFormVisibleValueVo extends TaobaoObject {
		private static final long serialVersionUID = 7619166881669292662L;
		/**
		 * cid是否加密
		 */
	...
	public static class SaveFormSchemaRequest extends TaobaoObject {
		private static final long serialVersionUID = 6152361453884295758L;
		/**
		 * 控件字符串
		 */
		@ApiField("content")
