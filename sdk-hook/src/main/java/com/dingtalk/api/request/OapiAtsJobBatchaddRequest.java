...
public class OapiAtsJobBatchaddRequest extends BaseTaobaoRequest<OapiAtsJobBatchaddResponse> {
	...
	* 操作人员工标识
	...
	public static class JobExtDataVo extends TaobaoObject {
		private static final long serialVersionUID = 2215685744189283791L;
		/**
		 * 招募人数
		 */
		@ApiField("head_count")
	...
	public static class JobAddressVo extends TaobaoObject {
		private static final long serialVersionUID = 8616135925442815955L;
		/**
		 * 位置详情
		 */
		@ApiField("detail")
	...
	public static class AtsAddJobParam extends TaobaoObject {
		private static final long serialVersionUID = 8746671975418352459L;
		/**
		 * 工作地点
		 */
		@ApiField("address")
