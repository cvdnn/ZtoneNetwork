...
public class OapiCollectionSchemaCreateRequest extends BaseTaobaoRequest<OapiCollectionSchemaCreateResponse> {
	...
	* 根请求
	...
	public static class ProcessVisibleValueVo extends TaobaoObject {
		private static final long serialVersionUID = 7879553399686982361L;
		/**
		 * 类型
		 */
	...
	public static class FormSchemaSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 1689289489418477659L;
		/**
		 * 业务类型
		 */
		@ApiField("biz_type")
	...
	public static class BehaviorTarget extends TaobaoObject {
		private static final long serialVersionUID = 6295847365151368358L;
		/**
		 * 行为
		 */
		@ApiField("behavior")
	...
	public static class BehaviorLinkageVo extends TaobaoObject {
		private static final long serialVersionUID = 2628945886338383471L;
		/**
		 * 选项级联目标
		 */
	...
	public static class ComponentPropOptionVo extends TaobaoObject {
		private static final long serialVersionUID = 6442265549498198644L;
		/**
		 * 名称
		 */
		@ApiField("key")
	...
	public static class ComponentMatrixDefVo extends TaobaoObject {
		private static final long serialVersionUID = 6812847768651464325L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 2152815244951615177L;
		/**
		 * 选项级联属性
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 8414286569363991387L;
		/**
		 * 控件名称
		 */
	...
	public static class FormContentVo extends TaobaoObject {
		private static final long serialVersionUID = 1674594237766334812L;
		/**
		 * 控件数组
		 */
		@ApiListField("items")
	...
	public static class SaveFormSchemaRequest extends TaobaoObject {
		private static final long serialVersionUID = 8186768244627224169L;
		/**
		 * 控件字符串
		 */
		@ApiField("content")
