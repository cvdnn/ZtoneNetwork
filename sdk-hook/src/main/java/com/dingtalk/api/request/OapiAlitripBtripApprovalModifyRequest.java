...
public class OapiAlitripBtripApprovalModifyRequest extends BaseTaobaoRequest<OapiAlitripBtripApprovalModifyResponse> {
	...
	* 请求对象
	...
	public static class OpenUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 7627861219585288973L;
		/**
		 * 出行人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenItineraryInfo extends TaobaoObject {
		private static final long serialVersionUID = 4435642916927916117L;
		/**
		 * 到达城市
		 */
		@ApiField("arr_city")
	...
	public static class OpenApiNewApplyRq extends TaobaoObject {
		private static final long serialVersionUID = 7555217385852718698L;
		/**
		 * 企业名称
		 */
		@ApiField("corp_name")
