...
public class OapiRhinoMosExecClothesConditionGetRequest extends BaseTaobaoRequest<OapiRhinoMosExecClothesConditionGetResponse> {
	...
	* 请求
	...
	public static class Source extends TaobaoObject {
		private static final long serialVersionUID = 5226476238724659152L;
		/**
		 * source_id
		 */
		@ApiField("source_id")
	...
	public static class EntityCondition extends TaobaoObject {
		private static final long serialVersionUID = 3267325584445132373L;
		/**
		 * 实体id
		 */
	...
	public static class Page extends TaobaoObject {
		private static final long serialVersionUID = 3348958656653545584L;
		/**
		 * 页大小
		 */
		@ApiField("page_size")
	...
	public static class GetClothesConditionReq extends TaobaoObject {
		private static final long serialVersionUID = 6661978766527294548L;
		/**
		 * 实体条件
		 */
		@ApiField("condition")
