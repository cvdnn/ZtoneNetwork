...
public class OapiAttendanceGroupAddRequest extends BaseTaobaoRequest<OapiAttendanceGroupAddResponse> {
	...
	* 考勤组信息
	...
	public static class TopPositionVo extends TaobaoObject {
		private static final long serialVersionUID = 2768236353694413157L;
		/**
		 * 精度
		 */
		@ApiField("accuracy")
	...
	public static class TopShiftVo extends TaobaoObject {
		private static final long serialVersionUID = 6811965821487184887L;
		/**
		 * 班次id
		 */
		@ApiField("id")
	...
	public static class TopMemberVo extends TaobaoObject {
		private static final long serialVersionUID = 7623388722577247538L;
		/**
		 * corpId
		 */
		@ApiField("corp_id")
	...
	public static class TopGroupManageRolePermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 3719139234596848243L;
		/**
		 * 设置拍照打卡规则
		 */
	...
	public static class TopWifiVo extends TaobaoObject {
		private static final long serialVersionUID = 8127676636675188456L;
		/**
		 * 企业corpid
		 */
		@ApiField("corp_id")
	...
	public static class TopGroupVo extends TaobaoObject {
		private static final long serialVersionUID = 2878263982893926963L;
		/**
		 * 打卡是否需要健康码
		 */
