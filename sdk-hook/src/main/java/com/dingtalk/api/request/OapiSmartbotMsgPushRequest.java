...
public class OapiSmartbotMsgPushRequest extends BaseTaobaoRequest<OapiSmartbotMsgPushResponse> {
	...
	* 接收者的用户userid列表
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 3169365332569948146L;
		/**
		 * 文本消息
		 */
		@ApiField("content")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 1745251827892353668L;
		/**
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 2594578678299281599L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 2132841219771834544L;
		/**
		 * 使用独立跳转ActionCard样式时的按钮列表；必须与btn_orientation同时设置
		 */
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 3885775381961848232L;
		/**
		 * 卡片消息
		 */
