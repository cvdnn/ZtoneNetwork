...
public class OapiWorkspaceCirclePostCreateRequest extends BaseTaobaoRequest<OapiWorkspaceCirclePostCreateResponse> {
	...
	* 创建动态的入参
	...
	public static class FvDingPanFileContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 1788576754931236311L;
		/**
	...
	public static class FvAttachmentsOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 7655553217256567288L;
		/**
		 * 钉盘文件列表
		 */
	...
	public static class FvPhotoOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 3661287519376965421L;
		/**
	...
	public static class FvPhotoContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 2662814213442954169L;
		/**
		 * 图片内容列表
		 */
		@ApiListField("photos")
	...
	public static class FvVideoContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 4226328525936796948L;
		/**
		 * 视频比特率
		 */
		@ApiField("bitrate")
	...
	public static class FvPostContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 1766338129853291479L;
		/**
		 * 附件内容
		 */
	...
	public static class FvPostTagOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 7579637233649642311L;
		/**
		 * 标签名
		 */
		@ApiField("name")
	...
	public static class FvPostCreateOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 2683764838158396284L;
		/**
		 * 动态的内容
		 */
		@ApiField("content")
