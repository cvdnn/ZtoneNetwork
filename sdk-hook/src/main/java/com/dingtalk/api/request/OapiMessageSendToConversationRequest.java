...
public class OapiMessageSendToConversationRequest extends BaseTaobaoRequest<OapiMessageSendToConversationResponse> {
	...
	* voice消息
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 6811661191825982878L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 1866514366585539917L;
		/**
		 * 消息体的关键字对应的值
		 */
		@ApiField("key")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 2895226969624857391L;
		/**
		 * 单行富文本信息的数目
		 */
		@ApiField("num")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 7467297227663488316L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 5897176573748633136L;
		/**
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 7221837565118228268L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 4333857682215798954L;
		/**
		 * 语音时长
		 */
		@ApiField("duration")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 3684322825388372255L;
		/**
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 7326519276579964126L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 4677934759998699747L;
		/**
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 1641821395885452596L;
		/**
		 * 消息内容
		 */
		@ApiField("content")
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 5267236644864433915L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 4526782699963961138L;
		/**
		 * 使用独立跳转ActionCard样式时的按钮列表；必须与btn_orientation同时设置
		 */
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 3352167448342365955L;
		/**
		 * 消息内容，支持markdown，语法参考标准markdown语法。图片举例：![alt text](mediaId)
		 */
