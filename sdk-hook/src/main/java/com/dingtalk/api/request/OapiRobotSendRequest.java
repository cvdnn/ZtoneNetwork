...
public class OapiRobotSendRequest extends BaseTaobaoRequest<OapiRobotSendResponse> {
	...
	* text类型
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 3688652648776424655L;
		/**
		 * text类型
		 */
		@ApiField("content")
	...
	public static class At extends TaobaoObject {
		private static final long serialVersionUID = 8466278463616793719L;
		/**
		 * 被@人的手机号
		 */
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 7237414318584897669L;
		/**
		 * 点击消息跳转的URL
		 */
		@ApiField("messageUrl")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 2387531915593234391L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class Btns extends TaobaoObject {
		private static final long serialVersionUID = 3514451392287211814L;
		/**
		 * 按钮方案，
		 */
		@ApiField("actionURL")
	...
	public static class Actioncard extends TaobaoObject {
		private static final long serialVersionUID = 8676589885625574288L;
		/**
		 * 0-按钮竖直排列，1-按钮横向排列
		 */
	...
	public static class Links extends TaobaoObject {
		private static final long serialVersionUID = 3553198776868955919L;
		/**
		 * 点击单条信息到跳转链接
		 */
		@ApiField("messageURL")
	...
	public static class Feedcard extends TaobaoObject {
		private static final long serialVersionUID = 7193468164383778684L;
		/**
		 * links
		 */
		@ApiListField("links")
