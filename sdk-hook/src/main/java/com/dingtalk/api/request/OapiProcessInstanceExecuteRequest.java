...
public class OapiProcessInstanceExecuteRequest extends BaseTaobaoRequest<OapiProcessInstanceExecuteResponse> {
	...
	* 请求
	...
	public static class Attachment extends TaobaoObject {
		private static final long serialVersionUID = 3228366244587877618L;
		/**
		 * 文件id
		 */
		@ApiField("file_id")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 1522857568926742384L;
		/**
		 * 附件
		 */
	...
	public static class ExecuteTaskRequest extends TaobaoObject {
		private static final long serialVersionUID = 7621423624122683427L;
		/**
