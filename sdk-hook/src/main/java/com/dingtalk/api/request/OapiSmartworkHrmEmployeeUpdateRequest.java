...
public class OapiSmartworkHrmEmployeeUpdateRequest extends BaseTaobaoRequest<OapiSmartworkHrmEmployeeUpdateResponse> {
	...
	* 添加待入职入参
	...
	public static class EmpFieldVo extends TaobaoObject {
		private static final long serialVersionUID = 1584326512191921383L;
		/**
		 * 更新的字段code
		 */
		@ApiField("field_code")
	...
	public static class EmpListFieldVO extends TaobaoObject {
		private static final long serialVersionUID = 7594487987829434399L;
		/**
		 * 单个组所有字段
		 */
	...
	public static class GroupMetaInfo extends TaobaoObject {
		private static final long serialVersionUID = 6282632829985233288L;
		/**
		 * 需改的字段所在组ID
		 */
		@ApiField("group_id")
	...
	public static class PreEntryEmployeeAddParam extends TaobaoObject {
		private static final long serialVersionUID = 5765994883848461866L;
		/**
		 * 所有组明细
		 */
		@ApiListField("groups")
