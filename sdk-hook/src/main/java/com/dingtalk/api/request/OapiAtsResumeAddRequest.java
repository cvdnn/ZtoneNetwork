...
public class OapiAtsResumeAddRequest extends BaseTaobaoRequest<OapiAtsResumeAddResponse> {
	...
	* 简历文件参数
	...
	public static class EducationInfo extends TaobaoObject {
		private static final long serialVersionUID = 8296946134745781965L;
		/**
		 * 学历
		 */
		@ApiField("education")
	...
	public static class ExperienceInfo extends TaobaoObject {
		private static final long serialVersionUID = 2773155199946391592L;
		/**
		 * 公司名称
		 */
		@ApiField("company")
	...
	public static class TrainingInfo extends TaobaoObject {
		private static final long serialVersionUID = 6222669396254968653L;
		/**
		 * 所获证书
		 */
	...
	public static class ProjectInfo extends TaobaoObject {
		private static final long serialVersionUID = 8734147735834312885L;
		/**
		 * 结束时间
		 */
		@ApiField("end_date")
	...
	public static class ResumeDetailInfo extends TaobaoObject {
		private static final long serialVersionUID = 8298365977382978586L;
		/**
		 * 学位
		 */
	...
	public static class CollResumeMailParam extends TaobaoObject {
		private static final long serialVersionUID = 6731321395515745522L;
		/**
		 * 渠道来源，接入前请提前沟通
		 */
		@ApiField("channel")
