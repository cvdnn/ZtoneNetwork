...
public class OapiSmartworkHrmMasterDeleteRequest extends BaseTaobaoRequest<OapiSmartworkHrmMasterDeleteResponse> {
	...
	* 业务方id(由系统统一分配)
	...
	public static class Fieldlist extends TaobaoObject {
		private static final long serialVersionUID = 4491264135594126173L;
		/**
		 * 字段名
		 */
		@ApiField("name")
	...
	public static class ScopeVo extends TaobaoObject {
		private static final long serialVersionUID = 8828693613422929367L;
		/**
		 * 业务域code
		 */
		@ApiField("scope_code")
	...
	public static class BizDataVo extends TaobaoObject {
		private static final long serialVersionUID = 7887335275865845178L;
		/**
		 * 数据业务时间戳
		 */
		@ApiField("biz_time")
