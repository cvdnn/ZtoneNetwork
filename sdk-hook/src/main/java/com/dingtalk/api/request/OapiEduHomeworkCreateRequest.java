...
public class OapiEduHomeworkCreateRequest extends BaseTaobaoRequest<OapiEduHomeworkCreateResponse> {
	...
	* 老师userid
	...
	public static class ClassInfoItem extends TaobaoObject {
		private static final long serialVersionUID = 8828491238398252444L;
		/**
		 * 班级ID
		 */
		@ApiField("class_id")
	...
	public static class StuInfoItem extends TaobaoObject {
		private static final long serialVersionUID = 6554652643145787227L;
		/**
		 * 学生userid
		 */
		@ApiField("stu_id")
	...
	public static class SelectStuItem extends TaobaoObject {
		private static final long serialVersionUID = 2596587172389213153L;
		/**
		 * 班级ID
		 */
		@ApiField("class_id")
