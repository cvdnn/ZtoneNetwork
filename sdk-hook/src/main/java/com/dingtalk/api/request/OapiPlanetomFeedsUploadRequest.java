...
public class OapiPlanetomFeedsUploadRequest extends BaseTaobaoRequest<OapiPlanetomFeedsUploadResponse> {
	...
	* 提交人的手机号码
	...
	public static class FeedContentModel extends TaobaoObject {
		private static final long serialVersionUID = 6466865667418672219L;
		/**
		 * 内容类型 2 视频 3 音频
		 */
		@ApiField("feed_type")
	...
	public static class FeedBaseModel extends TaobaoObject {
		private static final long serialVersionUID = 6265257344617195589L;
		/**
		 * 课程封面URL
		 */
		@ApiField("cover_url")
	...
	public static class FeedPayModel extends TaobaoObject {
		private static final long serialVersionUID = 8237744151966145231L;
		/**
		 * 客服手机号码
		 */
		@ApiField("cs_phone")
	...
	public static class BatchUploadFeedInfoModel extends TaobaoObject {
		private static final long serialVersionUID = 3366415343752914232L;
		/**
		 * 课程基础
		 */
		@ApiField("base_model")
