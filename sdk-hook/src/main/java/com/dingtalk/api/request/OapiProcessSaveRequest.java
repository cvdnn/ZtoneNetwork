...
public class OapiProcessSaveRequest extends BaseTaobaoRequest<OapiProcessSaveResponse> {
	...
	* 入参
	...
	public static class FormComponentStatVo extends TaobaoObject {
		private static final long serialVersionUID = 7778151954427484611L;
		/**
		 * 组件id
		 */
		@ApiField("id")
	...
	public static class FormComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 5117176531293887444L;
		/**
		 * 增加明细动作名称
		 */
	...
	public static class FormComponentVo2 extends TaobaoObject {
		private static final long serialVersionUID = 8813161329219682124L;
		/**
		 * 表单名称
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 4541485423366888782L;
		/**
		 * 子表单列表
		 */
	...
	public static class ProcessConfig extends TaobaoObject {
		private static final long serialVersionUID = 8364539614632298346L;
		/**
		 * 是否在审批后台禁用删除操作
		 */
	...
	public static class SaveProcessRequest extends TaobaoObject {
		private static final long serialVersionUID = 6568984165564519852L;
		/**
		 * 企业应用id
		 */
		@ApiField("agentid")
