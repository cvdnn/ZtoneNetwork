...
public class CorpCalendarCreateRequest extends BaseTaobaoRequest<CorpCalendarCreateResponse> {
	...
	* 创建日程实体
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 5783623817258712229L;
		/**
		 * 距开始时多久进行提醒(单位:分钟)
		 */
		@ApiField("minutes")
	...
	public static class DatetimeVo extends TaobaoObject {
		private static final long serialVersionUID = 6243399254456849762L;
		/**
		 * 时区
		 */
		@ApiField("timezone")
	...
	public static class OpenCalendarSourceVo extends TaobaoObject {
		private static final long serialVersionUID = 2395725562291676598L;
		/**
		 * 日程来源
		 */
		@ApiField("title")
	...
	public static class OpenCalendarCreateVo extends TaobaoObject {
		private static final long serialVersionUID = 1815761326265779397L;
		/**
		 * 业务方自己的主键
		 */
		@ApiField("biz_id")
