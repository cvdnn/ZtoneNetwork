...
public class OapiCalendarV2EventCreateRequest extends BaseTaobaoRequest<OapiCalendarV2EventCreateResponse> {
	...
	* 日程创建对象
	...
	public static class Attendee extends TaobaoObject {
		private static final long serialVersionUID = 2228227591433951352L;
		/**
		 * 员工工号
		 */
		@ApiField("userid")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 6141419126163279912L;
		/**
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 4177823839827888272L;
		/**
		 * 提醒方式.app表示应用内提醒
		 */
		@ApiField("method")
	...
	public static class LocationVo extends TaobaoObject {
		private static final long serialVersionUID = 6542848465554421598L;
		/**
		 * 纬度
		 */
		@ApiField("latitude")
	...
	public static class Event extends TaobaoObject {
		private static final long serialVersionUID = 8827344477764257528L;
		/**
		 * 日程参与者，参与者最大人数为100(包括组织者)
		 */
