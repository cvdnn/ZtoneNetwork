...
public class OapiChatSendRequest extends BaseTaobaoRequest<OapiChatSendResponse> {
	...
	* 语音消息
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 1181641197799238111L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 2111787115552773475L;
		/**
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 7819736948462667729L;
		/**
		 * 消息头部背景颜色
		 */
		@ApiField("bgcolor")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 8462936482486465961L;
		/**
		 * 单行富文本信息的单位
		 */
		@ApiField("num")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 1827957425752783549L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 6182246181266221438L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 3431696593433691445L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 3638783564261934851L;
		/**
		 * 语音正整数，小于60，表示音频时长长
		 */
		@ApiField("duration")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 8267764721964283919L;
		/**
		 * 文件mediaId
		 */
		@ApiField("media_id")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 7678997162657364785L;
		/**
		 * 图片mediaId
		 */
		@ApiField("media_id")
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 8327379465936346994L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 6234127865631569514L;
		/**
		 * 文本消息内容
		 */
		@ApiField("content")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 7279652758555836433L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 7771432113125984196L;
		/**
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 7713697559343796732L;
		/**
		 * action_card卡片消息
		 */
