...
public class OapiCalendarCreateRequest extends BaseTaobaoRequest<OapiCalendarCreateResponse> {
	...
	* 创建日程实体
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 1754879842561876955L;
		/**
		 * 距开始时多久进行提醒(单位:分钟)
		 */
		@ApiField("minutes")
	...
	public static class DatetimeVo extends TaobaoObject {
		private static final long serialVersionUID = 3298252158219287126L;
		/**
		 * 时区
		 */
		@ApiField("timezone")
	...
	public static class OpenCalendarSourceVo extends TaobaoObject {
		private static final long serialVersionUID = 2642779646266196589L;
		/**
		 * 日程来源
		 */
		@ApiField("title")
	...
	public static class OpenCalendarCreateVo extends TaobaoObject {
		private static final long serialVersionUID = 6747143518416113995L;
		/**
		 * 业务方自己的主键
		 */
		@ApiField("biz_id")
