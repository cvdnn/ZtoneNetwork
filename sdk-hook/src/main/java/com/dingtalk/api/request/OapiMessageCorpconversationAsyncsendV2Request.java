...
public class OapiMessageCorpconversationAsyncsendV2Request extends BaseTaobaoRequest<OapiMessageCorpconversationAsyncsendV2Response> {
	...
	* 接收者的用户userid列表
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 6753283758299358351L;
		/**
		 * 文本消息
		 */
		@ApiField("content")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 3282267944142417446L;
		/**
		 * 图片消息
		 */
		@ApiField("media_id")
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 1579648252278595449L;
		/**
		 * 图片地址
		 */
		@ApiField("messageUrl")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 7715952519894716836L;
		/**
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 3355551479121732712L;
		/**
		 * 正整数，小于60，表示音频时长
		 */
		@ApiField("duration")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 3862839979339229284L;
		/**
		 * 单行富文本信息的数目
		 */
		@ApiField("num")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 2379186846656689191L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 5419393911819379941L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 3169194235632346342L;
		/**
	...
	public static class OA extends TaobaoObject {
		private static final long serialVersionUID = 8633279121354431891L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 8412119227987573614L;
		/**
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 3155137635494787167L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 4363172532366416788L;
		/**
		 * 使用独立跳转ActionCard样式时的按钮列表；必须与btn_orientation同时设置
		 */
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 4893864682945791472L;
		/**
		 * 卡片消息
		 */
