...
public class OapiAtsRpaResumeMailCollectRequest extends BaseTaobaoRequest<OapiAtsRpaResumeMailCollectResponse> {
	...
	* 简历文件参数
	...
	public static class MailContent extends TaobaoObject {
		private static final long serialVersionUID = 2112113367948419471L;
		/**
		 * 邮件正文，可选
		 */
		@ApiField("body_html")
	...
	public static class ResumeFileStoreVo extends TaobaoObject {
		private static final long serialVersionUID = 4856134232739946238L;
		/**
		 * 下载地址
		 */
	...
	public static class EducationInfo extends TaobaoObject {
		private static final long serialVersionUID = 4428919835322121725L;
		/**
		 * 学历
		 */
		@ApiField("education")
	...
	public static class ExperienceInfo extends TaobaoObject {
		private static final long serialVersionUID = 6853871465351411942L;
		/**
		 * 公司名称
		 */
		@ApiField("company")
	...
	public static class TrainingInfo extends TaobaoObject {
		private static final long serialVersionUID = 7829765576136681577L;
		/**
		 * 所获证书
		 */
	...
	public static class ProjectInfo extends TaobaoObject {
		private static final long serialVersionUID = 8565255426642964761L;
		/**
		 * 结束时间
		 */
		@ApiField("end_date")
	...
	public static class ResumeDetailInfo extends TaobaoObject {
		private static final long serialVersionUID = 3458499786937266433L;
		/**
		 * 学位
		 */
	...
	public static class CollResumeMailParam extends TaobaoObject {
		private static final long serialVersionUID = 3859276917959747385L;
		/**
		 * 渠道来源，接入前请提前沟通
		 */
		@ApiField("channel")
