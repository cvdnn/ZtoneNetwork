...
public class OapiEduCourseSummadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7649382313664958954L;
	...
	public static class CourseSummaryDataDTO extends TaobaoObject {
		private static final long serialVersionUID = 8146236473699569258L;
		/**
		 * 数据类别业务唯一键
		 */
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7435296463492533484L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
