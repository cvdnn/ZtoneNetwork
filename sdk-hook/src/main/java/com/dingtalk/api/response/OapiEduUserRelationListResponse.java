...
public class OapiEduUserRelationListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5256898556134962896L;
	...
	public static class OpenEduUserRelationDetail extends TaobaoObject {
		private static final long serialVersionUID = 2412436345839193728L;
		/**
		 * 班级id
		 */
		@ApiField("class_id")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 7839568692112857272L;
		/**
		 * 是否还存在数据
		 */
		@ApiField("has_more")
