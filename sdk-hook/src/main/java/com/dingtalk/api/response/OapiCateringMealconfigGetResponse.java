...
public class OapiCateringMealconfigGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4121853988167473912L;
	...
	public static class Mealitemlist extends TaobaoObject {
		private static final long serialVersionUID = 5223186324248215265L;
		/**
		 * 送达时间 HH:mm
		 */
	...
	public static class Addressvos extends TaobaoObject {
		private static final long serialVersionUID = 2459475381297469134L;
		/**
		 * 缩略地址，可为空
		 */
		@ApiField("address")
	...
	public static class GroupMealSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 3277838538251969327L;
		/**
		 * 缩略地址，可为空
		 */
		@ApiField("address")
