...
public class OapiCrmAuthGroupMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7764957292871531155L;
	...
	public static class Staff extends TaobaoObject {
		private static final long serialVersionUID = 5797451847398312547L;
		/**
		 * 员工姓名
		 */
		@ApiField("name")
	...
	public static class Dept extends TaobaoObject {
		private static final long serialVersionUID = 6846385772729327556L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class Tag extends TaobaoObject {
		private static final long serialVersionUID = 5669831647823625271L;
		/**
		 * 角色名称
		 */
		@ApiField("name")
	...
	public static class MemberInfo extends TaobaoObject {
		private static final long serialVersionUID = 6727987859657527949L;
		/**
		 * 是否是全员分组
		 */
		@ApiField("all_member")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 5827678967524115944L;
		/**
		 * 成员信息
		 */
