...
public class OapiKacDatavTelconfDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7687283133863277797L;
	...
	public static class TelConferenceDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 7398115782657667382L;
		/**
		 * 会议id
		 */
		@ApiField("conf_id")
	...
	public static class TelConferenceDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 5531176663132544191L;
		/**
		 * data
		 */
		@ApiListField("data")
