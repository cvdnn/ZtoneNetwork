...
public class OapiLiveGroupliveViewrecordResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4834313447519379572L;
	...
	public static class UserViewRecordDetailModelList extends TaobaoObject {
		private static final long serialVersionUID = 3411167223468856526L;
		/**
		 * 开始观看时间戳
		 */
	...
	public static class QueryLiveViewRecordDetail extends TaobaoObject {
		private static final long serialVersionUID = 2198929231238663645L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
