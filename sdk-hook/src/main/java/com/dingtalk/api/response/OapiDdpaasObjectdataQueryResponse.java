...
public class OapiDdpaasObjectdataQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1372588959298773713L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 3215485938872148733L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 2738877228432761119L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 8717287761336519138L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
