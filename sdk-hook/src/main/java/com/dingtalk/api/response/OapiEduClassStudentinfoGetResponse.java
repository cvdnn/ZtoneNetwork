...
public class OapiEduClassStudentinfoGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7885459256634278527L;
	...
	public static class OpenPatriarchSelectDto extends TaobaoObject {
		private static final long serialVersionUID = 3228558225728964556L;
		/**
		 * 头像
		 */
		@ApiField("avatar")
	...
	public static class OpenStudentSelectDto extends TaobaoObject {
		private static final long serialVersionUID = 5711716244968388411L;
		/**
		 * 头像
		 */
		@ApiField("avatar")
