...
public class OapiAttendanceShiftHistoryQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8286665194319985175L;
	...
	public static class TopShiftSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 4623483159636491449L;
		/**
		 * 该班次对应的出勤天数
		 */
	...
	public static class TopPunchVo extends TaobaoObject {
		private static final long serialVersionUID = 5578597115711137953L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class TopRestVo extends TaobaoObject {
		private static final long serialVersionUID = 5788989149583657837L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class TopSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 8766363899646843384L;
		/**
		 * id
		 */
		@ApiField("id")
	...
	public static class TopShiftVo extends TaobaoObject {
		private static final long serialVersionUID = 4292166746864866257L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
