...
public class OapiSmartdeviceAtmachineGetByDeptidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8231933473316927192L;
	...
	public static class MachineVo extends TaobaoObject {
		private static final long serialVersionUID = 6574746392557956194L;
		/**
		 * 考勤机名称
		 */
	...
	public static class MachineInfoResultVo extends TaobaoObject {
		private static final long serialVersionUID = 7145518859458247624L;
		/**
		 * 分页查询中，后页是否还有数据
		 */
		@ApiField("has_more")
