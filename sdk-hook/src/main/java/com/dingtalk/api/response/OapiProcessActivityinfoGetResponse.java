...
public class OapiProcessActivityinfoGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7256182467648673915L;
	...
	public static class ActivityModel extends TaobaoObject {
		private static final long serialVersionUID = 5781496414189527869L;
		/**
		 * 节点id
		 */
	...
	public static class ProcessActivityTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3118427123419978226L;
		/**
		 * 节点信息列表
		 */
		@ApiListField("models")
