...
public class OapiAlitripBtripTrainCitySuggestResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3577529622833111116L;
	...
	public static class CityVo extends TaobaoObject {
		private static final long serialVersionUID = 5314557586812464599L;
		/**
		 * 城市码
		 */
		@ApiField("code")
	...
	public static class SuggestRs extends TaobaoObject {
		private static final long serialVersionUID = 8495821394924819152L;
		/**
		 * 城市列表
		 */
		@ApiListField("cities")
