...
public class OapiAttendanceGetsimplegroupsResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4367857193429574367L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 7723554584843881639L;
		/**
		 * 开始时间
		 */
		@ApiField("check_time")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 8499592853754347246L;
		/**
		 * 旷工迟到时长,单位分钟
		 */
	...
	public static class SetionTimeVO extends TaobaoObject {
		private static final long serialVersionUID = 8547258498571458681L;
		/**
		 * 打卡时间跨度
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 2144223732857739882L;
		/**
		 * 时间段列表
		 */
		@ApiListField("times")
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 7149489534591945234L;
		/**
		 * 考勤班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3748238443925411822L;
		/**
	...
	public static class AtGroupListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2814471736442918176L;
		/**
		 * 考勤组列表
		 */
		@ApiListField("groups")
