...
public class OapiAtsPluginStatisticsJobListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3334694198951291281L;
	...
	public static class TopJobStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 2793857351584657879L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 3337742585728322171L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
