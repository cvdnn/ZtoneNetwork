...
public class OapiKacDatavVideoconfDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2456939651657311431L;
	...
	public static class McsDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 8137197153576296121L;
		/**
		 * 会议id
		 */
		@ApiField("conf_id")
	...
	public static class McsDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 2375327463358551284L;
		/**
		 * data
		 */
		@ApiListField("data")
