...
public class OapiRhinoHumanresEmployeeProductionteamListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5839559241499617873L;
	...
	public static class ProductionTeamList extends TaobaoObject {
		private static final long serialVersionUID = 6646482144313592156L;
		/**
		 * 生产组业务ID
		 */
		@ApiField("biz_id")
	...
	public static class Model extends TaobaoObject {
		private static final long serialVersionUID = 6592869567728136716L;
		/**
		 * 部门邮箱
		 */
		@ApiField("bu_mail")
