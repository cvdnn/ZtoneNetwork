...
public class CorpHrmEmployeeGetdismissionlistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7897365638241657237L;
	...
	public static class HrmApiDismissionModel extends TaobaoObject {
		private static final long serialVersionUID = 7613149974366197759L;
		/**
		 * 入职时间
		 */
	...
	public static class HrmApiPage extends TaobaoObject {
		private static final long serialVersionUID = 2877587544438715582L;
		/**
		 * 当前页
		 */
		@ApiField("current")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 6588778691577785193L;
		/**
		 * 错误码
		 */
