...
public class OapiKacDatavDeptVideoliveListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3834685442861224844L;
	...
	public static class VideoLiveDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 4261544867387377543L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class VideoLiveDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7393857765674785488L;
		/**
		 * data
		 */
		@ApiListField("data")
