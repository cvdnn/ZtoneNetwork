...
public class OapiAlitripBtripApplySearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3545476386663327538L;
	...
	public static class OpenItineraryInfo extends TaobaoObject {
		private static final long serialVersionUID = 7537276579632289171L;
		/**
		 * 到达城市
		 */
		@ApiField("arr_city")
	...
	public static class OpenUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 6351311355761159254L;
		/**
		 * 用户名称
		 */
		@ApiField("user_name")
	...
	public static class OpenApproverInfo extends TaobaoObject {
		private static final long serialVersionUID = 1771996461733265877L;
		/**
		 * 审批意见
		 */
		@ApiField("note")
	...
	public static class OpenApplyRs extends TaobaoObject {
		private static final long serialVersionUID = 8159833196567452528L;
		/**
		 * 商旅审批展示id
		 */
