...
public class OapiCrmAuthGroupPermissionListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5862544637638474269L;
	...
	public static class OperateScope extends TaobaoObject {
		private static final long serialVersionUID = 7549666354647939414L;
		/**
		 * 是否有权限
		 */
		@ApiField("has_auth")
	...
	public static class DeptInfo extends TaobaoObject {
		private static final long serialVersionUID = 3526829797642823311L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class StaffInfo extends TaobaoObject {
		private static final long serialVersionUID = 6754213789813545565L;
		/**
		 * 员工名称
		 */
		@ApiField("name")
	...
	public static class Ext extends TaobaoObject {
		private static final long serialVersionUID = 8861723492561894463L;
		/**
		 * 管理部门信息
		 */
	...
	public static class ManageScope extends TaobaoObject {
		private static final long serialVersionUID = 3446522965247819258L;
		/**
		 * 扩展内容
		 */
		@ApiField("ext")
	...
	public static class AuthObjects extends TaobaoObject {
		private static final long serialVersionUID = 6156734621835518856L;
		/**
		 * 表单名称
		 */
		@ApiField("label")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 4328957837831594839L;
		/**
		 * 权限内容
		 */
