...
public class OapiRhinoMosLayoutOperationdefsSectionfirstResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1513434351369613718L;
	...
	public static class OperationExecutorAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 4148882787298516652L;
		/**
		 * 工序执行器ID
		 */
	...
	public static class DeviceAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 8388725262797813792L;
		/**
		 * 设备ID
		 */
		@ApiField("device_id")
	...
	public static class WorkerAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 5381824754167979423L;
		/**
		 * 姓名
		 */
		@ApiField("name")
	...
	public static class WorkstationAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 4132288332882826193L;
		/**
		 * 站位编码
		 */
	...
	public static class WorkUnitDto extends TaobaoObject {
		private static final long serialVersionUID = 6676985432593941974L;
		/**
		 * 设备分配列表
		 */
	...
	public static class OperationDefDto extends TaobaoObject {
		private static final long serialVersionUID = 8659992919683757341L;
		/**
		 * 适用尺码
		 */
