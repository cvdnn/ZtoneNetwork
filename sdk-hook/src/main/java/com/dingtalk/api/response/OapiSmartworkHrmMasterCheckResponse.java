...
public class OapiSmartworkHrmMasterCheckResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4585255548399522745L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 4327636393174764475L;
		/**
		 * 业务UK唯一确定一条流水
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVo extends TaobaoObject {
		private static final long serialVersionUID = 4267679954436813138L;
		/**
		 * 是否全部处理成功
		 */
