...
public class OapiEduUseridGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5825789855794285566L;
	...
	public static class UserIdHold extends TaobaoObject {
		private static final long serialVersionUID = 7894492722547642979L;
		/**
		 * 手机号码
		 */
		@ApiField("mobile")
	...
	public static class OpenEduUserIdListResponse extends TaobaoObject {
		private static final long serialVersionUID = 3857554591518338817L;
		/**
		 * 用户id列表
		 */
		@ApiListField("users")
