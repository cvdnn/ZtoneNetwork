...
public class OapiSmartdeviceMeetingroomParticipantListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1328325988796621353L;
	...
	public static class MemeberOpenInfo extends TaobaoObject {
		private static final long serialVersionUID = 3442732868479623978L;
		/**
		 * 参会人userid
		 */
		@ApiField("userid")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 7361866429954464136L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
