...
public class OapiWorkspaceProjectMemberAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5369895819155946412L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 8586346219547234541L;
		/**
		 * 角色的code
		 */
		@ApiField("code")
	...
	public static class OpenProjectMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 4814129199262453993L;
		/**
		 * 组织id
		 */
		@ApiField("corp_id")
