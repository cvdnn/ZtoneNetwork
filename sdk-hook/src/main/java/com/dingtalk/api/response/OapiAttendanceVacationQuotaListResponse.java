...
public class OapiAttendanceVacationQuotaListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2251496268198949863L;
	...
	public static class Leavequotas extends TaobaoObject {
		private static final long serialVersionUID = 3328219868884572119L;
		/**
		 * 额度有效期结束时间(毫秒级时间戳)
		 */
		@ApiField("end_time")
	...
	public static class OapiLeaveQuotaUserListVo extends TaobaoObject {
		private static final long serialVersionUID = 2396144837816761682L;
		/**
		 * 是否存在更多记录
		 */
		@ApiField("has_more")
