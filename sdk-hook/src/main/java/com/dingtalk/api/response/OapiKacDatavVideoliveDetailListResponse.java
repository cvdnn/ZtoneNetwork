...
public class OapiKacDatavVideoliveDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2892773439918711745L;
	...
	public static class VideoLiveDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 8384274813455111386L;
		/**
		 * 直播群cid
		 */
		@ApiField("cid")
	...
	public static class VideoLiveDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 8374711979691893351L;
		/**
		 * 数据明细列表
		 */
		@ApiListField("data")
