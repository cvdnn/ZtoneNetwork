...
public class OapiSmartdeviceMeetingroomListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7651163436917887775L;
	...
	public static class MeetingRoomOpenInfo extends TaobaoObject {
		private static final long serialVersionUID = 7733181684138351558L;
		/**
		 * 会议室容量
		 */
		@ApiField("capacity")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 6624986766248693586L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
