...
public class OapiKacDatavDeptTelconfListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6269822552484812426L;
	...
	public static class TelConferenceDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 3236476148196367714L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class TelConferenceDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7255576682398173882L;
		/**
		 * data
		 */
		@ApiListField("data")
