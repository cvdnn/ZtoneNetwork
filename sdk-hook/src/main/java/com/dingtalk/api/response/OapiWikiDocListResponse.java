...
public class OapiWikiDocListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8137516316487254436L;
	...
	public static class OpenDocVO extends TaobaoObject {
		private static final long serialVersionUID = 8557284378596452946L;
		/**
		 * 知识库ID（加密后的）
		 */
		@ApiField("group_id")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 5369247914786355666L;
		/**
		 * 知识页列表
		 */
		@ApiListField("data")
