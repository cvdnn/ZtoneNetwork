...
public class OapiWikiDocPublicListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6422411427136611762L;
	...
	public static class OpenDocVo extends TaobaoObject {
		private static final long serialVersionUID = 4233159119359632946L;
		/**
		 * 知识页所在知识库id（加密后的值）
		 */
		@ApiField("group_id")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 1467584444118411156L;
		/**
		 * 知识页列表
		 */
		@ApiListField("data")
