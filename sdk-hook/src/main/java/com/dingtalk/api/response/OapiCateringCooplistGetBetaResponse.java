...
public class OapiCateringCooplistGetBetaResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1881219727277525953L;
	...
	public static class Mealitemlist extends TaobaoObject {
		private static final long serialVersionUID = 5638495752854572821L;
		/**
		 * 送达时间 HH:mm
		 */
	...
	public static class MealSettingList extends TaobaoObject {
		private static final long serialVersionUID = 1649199235171734844L;
		/**
		 * 缩略地址，可为空
		 */
		@ApiField("address")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 1217353166367911253L;
		/**
		 * 是否有下一项数据
		 */
		@ApiField("has_next")
