...
public class OapiCrmObjectmetaFollowrecordDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8154717559478873565L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 7498465458118744157L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 3321296294853271658L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 7274691737179223986L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 4797437768279981126L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 7626841915151539465L;
		/**
		 * 是否自定义对象
		 */
		@ApiField("customized")
