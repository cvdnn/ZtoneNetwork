...
public class OapiMessageCorpconversationGetsendresultResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7712787367138214163L;
	...
	public static class SendForbiddenModel extends TaobaoObject {
		private static final long serialVersionUID = 2135695482125557763L;
		/**
		 * 流控code
		 */
		@ApiField("code")
	...
	public static class AsyncSendResult extends TaobaoObject {
		private static final long serialVersionUID = 8821768785844255937L;
		/**
		 * 发送失败的用户id
		 */
