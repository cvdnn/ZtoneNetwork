...
public class OapiDingpayOrderTerminateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3588824354965199617L;
	...
	public static class OrderTerminateResultItem extends TaobaoObject {
		private static final long serialVersionUID = 6588664356254241254L;
		/**
		 * 订单号
		 */
		@ApiField("order_no")
	...
	public static class OrderTerminationOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 6121443256494943944L;
		/**
		 * 终止结果列表
		 */
