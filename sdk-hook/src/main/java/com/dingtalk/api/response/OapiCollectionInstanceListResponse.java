...
public class OapiCollectionInstanceListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4134472489717582885L;
	...
	public static class FormData extends TaobaoObject {
		private static final long serialVersionUID = 7138219924873278339L;
		/**
		 * 表单控件key
		 */
		@ApiField("key")
	...
	public static class FormInstanceResponse extends TaobaoObject {
		private static final long serialVersionUID = 3475879948622927976L;
		/**
		 * 毫秒级时间戳，填表提交时间
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 3536977616471653723L;
		/**
		 * 是否还有下一页
		 */
		@ApiField("has_more")
