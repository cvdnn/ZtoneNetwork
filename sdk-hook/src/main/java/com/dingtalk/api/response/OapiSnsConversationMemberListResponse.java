...
public class OapiSnsConversationMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6251463931592293869L;
	...
	public static class SnsGroupMemberModel extends TaobaoObject {
		private static final long serialVersionUID = 6433344445368825621L;
		/**
		 * 群昵称
		 */
	...
	public static class SnsOpenGroupMemberResponse extends TaobaoObject {
		private static final long serialVersionUID = 3193951836833493215L;
		/**
		 * 群成员是否还有下页数据
		 */
		@ApiField("has_more")
