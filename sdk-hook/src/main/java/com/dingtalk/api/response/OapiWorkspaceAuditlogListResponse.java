...
public class OapiWorkspaceAuditlogListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4338781488731638688L;
	...
	public static class EventAuditLogDto extends TaobaoObject {
		private static final long serialVersionUID = 3764191459836562345L;
		/**
		 * 操作类型
		 */
		@ApiField("action")
	...
	public static class OpenAuditLogDto extends TaobaoObject {
		private static final long serialVersionUID = 4463114672455152296L;
		/**
		 * 记录列表
		 */
