...
public class OapiRhinoMosLayoutOperationdefGetflowResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3737917676257214444L;
	...
	public static class OperationExecutorAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 4263845421732727173L;
		/**
		 * 工序执行器ID
		 */
	...
	public static class DeviceAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 3815963461952295953L;
		/**
		 * 设备ID
		 */
		@ApiField("device_id")
	...
	public static class WorkerAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 1275427842382611451L;
		/**
		 * 姓名
		 */
		@ApiField("name")
	...
	public static class WorkstationAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 4323357853661422858L;
		/**
		 * 站位编码
		 */
	...
	public static class WorkUnitDto extends TaobaoObject {
		private static final long serialVersionUID = 4451191556688588323L;
		/**
		 * 设备分配列表
		 */
	...
	public static class OperationDefDto extends TaobaoObject {
		private static final long serialVersionUID = 3167951696718271356L;
		/**
		 * 适用尺码
		 */
	...
	public static class OperationDefFlowDto extends TaobaoObject {
		private static final long serialVersionUID = 8411882871346877668L;
		/**
		 * 是否激活最大版本
		 */
		@ApiField("active")
