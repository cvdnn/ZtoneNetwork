...
public class OapiEduSubjectMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2189876786354652577L;
	...
	public static class SubjectMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 8461785235237228176L;
		/**
		 * 区域编码
		 */
		@ApiField("area_code")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7875184523224358874L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
