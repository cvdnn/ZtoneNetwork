...
public class OapiWorkbenchShortcutListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4558548254772368381L;
	...
	public static class IsvOrgShortcutDTO extends TaobaoObject {
		private static final long serialVersionUID = 5436231454459634597L;
		/**
		 * 业务单号,系统间交互唯一流水号
		 */
		@ApiField("biz_no")
	...
	public static class IsvOrgShortcutListDTO extends TaobaoObject {
		private static final long serialVersionUID = 5751546522823426511L;
		/**
		 * 企业下指定应用已添加快捷方式列表
		 */
