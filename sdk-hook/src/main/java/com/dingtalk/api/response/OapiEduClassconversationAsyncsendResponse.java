...
public class OapiEduClassconversationAsyncsendResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8282829841921974259L;
	...
	public static class TopSendConversationMsgResponse extends TaobaoObject {
		private static final long serialVersionUID = 5549173615994735414L;
		/**
		 * 异步任务id
		 */
		@ApiField("task_id")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 5415923122469675531L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
