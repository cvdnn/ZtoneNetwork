...
public class OapiCrmObjectdataQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5176741315928592249L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 8531589826939569546L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 1278943285813995791L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 1239481253328211641L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
