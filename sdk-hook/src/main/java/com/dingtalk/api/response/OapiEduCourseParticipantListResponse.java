...
public class OapiEduCourseParticipantListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1773924176564166977L;
	...
	public static class CourseParticipantVO extends TaobaoObject {
		private static final long serialVersionUID = 8311645169478263785L;
		/**
		 * 参与方的组织CorpId
		 */
	...
	public static class ListCourseParticipantResponse extends TaobaoObject {
		private static final long serialVersionUID = 6736719687565915195L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
