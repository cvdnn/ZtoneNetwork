...
public class OapiProcessinstanceListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3727595937639815544L;
	...
	public static class FormComponentValueVo extends TaobaoObject {
		private static final long serialVersionUID = 2377936344662767634L;
		/**
		 * 组件类型
		 */
	...
	public static class ProcessInstanceTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6822488376757644267L;
		/**
		 * 审批人列表
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 1629579134667684825L;
		/**
		 * list
		 */
		@ApiListField("list")
