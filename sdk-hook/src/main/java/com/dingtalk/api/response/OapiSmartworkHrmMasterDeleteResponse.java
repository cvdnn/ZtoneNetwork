...
public class OapiSmartworkHrmMasterDeleteResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3127584565443327691L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 7619318534346982899L;
		/**
		 * 业务UK,唯一确定一条流水
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVo extends TaobaoObject {
		private static final long serialVersionUID = 1672423654253489451L;
		/**
		 * 是否全部成功
		 */
