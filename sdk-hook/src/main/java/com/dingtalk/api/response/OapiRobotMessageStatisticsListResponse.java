...
public class OapiRobotMessageStatisticsListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1354488116853331977L;
	...
	public static class MsgStatResVo extends TaobaoObject {
		private static final long serialVersionUID = 2421328595913171619L;
		/**
		 * 机器人消息推送Id
		 */
		@ApiField("push_id")
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 1161346873861987791L;
		/**
		 * 当前页数
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 7669148656152623926L;
		/**
		 * list
		 */
		@ApiListField("list")
