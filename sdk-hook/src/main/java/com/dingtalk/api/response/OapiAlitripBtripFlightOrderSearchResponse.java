...
public class OapiAlitripBtripFlightOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6694947332544146613L;
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 1673825567632467292L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 5615368191466927128L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 7474168957177235413L;
		/**
		 * 交易类目
		 */
		@ApiField("category")
	...
	public static class OpenFlightInsureInfo extends TaobaoObject {
		private static final long serialVersionUID = 4399956256326133293L;
		/**
		 * 保单号
		 */
		@ApiField("insure_no")
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 6223589377264636877L;
		/**
		 * 出行人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenFlightOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 6169952212371263335L;
		/**
		 * 商旅申请单id
		 */
		@ApiField("apply_id")
