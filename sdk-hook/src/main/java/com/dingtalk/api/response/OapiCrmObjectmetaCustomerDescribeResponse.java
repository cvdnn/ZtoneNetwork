...
public class OapiCrmObjectmetaCustomerDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4392673662134431969L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 3491959491826528123L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 4796737191112411235L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 5497531731378254755L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 8117566937237391922L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 7295327174647595528L;
		/**
		 * 是否自定义对象
		 */
		@ApiField("customized")
