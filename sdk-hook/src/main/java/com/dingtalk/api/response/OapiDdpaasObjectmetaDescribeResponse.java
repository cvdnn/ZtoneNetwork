...
public class OapiDdpaasObjectmetaDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5432822898174473454L;
	...
	public static class Selectoptions extends TaobaoObject {
		private static final long serialVersionUID = 6159828624956412837L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class Referencefields extends TaobaoObject {
		private static final long serialVersionUID = 6484748543357138786L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class Rollupsummaryfields extends TaobaoObject {
		private static final long serialVersionUID = 5713519537559524573L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 6414881749188153786L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 1133191243242627769L;
		/**
		 * 字段列表
		 */
		@ApiListField("fields")
