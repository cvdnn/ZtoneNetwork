...
public class OapiSmartworkHrmMasterSaveResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2445858413578389868L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 2411296364978697572L;
		/**
		 * 业务流水唯一标识，和入参一致
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVO extends TaobaoObject {
		private static final long serialVersionUID = 8285882283459216525L;
		/**
		 * 是否全部保存成功
		 */
