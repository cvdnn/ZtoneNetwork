...
public class OapiOrgListshortcutResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6366626441182284527L;
	...
	public static class OrgShortcutVO extends TaobaoObject {
		private static final long serialVersionUID = 3688984456837264164L;
		/**
		 * 类型，1表示工作台微应用
		 */
		@ApiField("type")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 4397732696574737933L;
		/**
		 * dingOpenErrcode
		 */
		@ApiField("errcode")
