...
public class OapiCrmObjectdataFollowrecordQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2247884217317462375L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 2675182557532385596L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 7825263993838799551L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 2165979436592541635L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
