...
public class OapiRoleListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8738814331337271191L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 6736228351437875591L;
		/**
		 * 角色id
		 */
		@ApiField("id")
	...
	public static class OpenRoleGroup extends TaobaoObject {
		private static final long serialVersionUID = 6892248348591121381L;
		/**
		 * 角色组id
		 */
		@ApiField("groupId")
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 3828563384191638722L;
		/**
		 * hasMore
		 */
		@ApiField("hasMore")
