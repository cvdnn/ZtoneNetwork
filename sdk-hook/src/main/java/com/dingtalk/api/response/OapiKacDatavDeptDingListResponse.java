...
public class OapiKacDatavDeptDingListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7146976956137883919L;
	...
	public static class DingUsageDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 2734919128219952796L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class DingUsageDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7612465252973671678L;
		/**
		 * data
		 */
		@ApiListField("data")
