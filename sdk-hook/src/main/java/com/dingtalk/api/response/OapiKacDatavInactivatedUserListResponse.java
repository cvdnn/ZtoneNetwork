...
public class OapiKacDatavInactivatedUserListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5757319438232727278L;
	...
	public static class UnactivatedUserVo extends TaobaoObject {
		private static final long serialVersionUID = 2222613449835426376L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class UnactivatedUserResponse extends TaobaoObject {
		private static final long serialVersionUID = 2478511393579766715L;
		/**
		 * 人员列表
		 */
		@ApiListField("data")
