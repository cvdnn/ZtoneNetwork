...
public class OapiAlitripBtripPriceQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4763628245674451522L;
	...
	public static class HotelFeeDetail extends TaobaoObject {
		private static final long serialVersionUID = 5268559561998521753L;
		/**
		 * 城市
		 */
		@ApiField("city")
	...
	public static class MostExpensive extends TaobaoObject {
		private static final long serialVersionUID = 2551427687432363552L;
		/**
		 * 到达时间
		 */
		@ApiField("arr_time")
	...
	public static class Cheapest extends TaobaoObject {
		private static final long serialVersionUID = 5545447981598554771L;
		/**
		 * 到达时间
		 */
		@ApiField("arr_time")
	...
	public static class BtripRoutes extends TaobaoObject {
		private static final long serialVersionUID = 6478551857615684599L;
		/**
		 * 最低价
		 */
		@ApiField("cheapest")
	...
	public static class TrafficFee extends TaobaoObject {
		private static final long serialVersionUID = 6369483615872723411L;
		/**
		 * 行程费用
		 */
	...
	public static class Module extends TaobaoObject {
		private static final long serialVersionUID = 1438853335691899783L;
		/**
		 * 酒店差标
		 */
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 6497636869932754287L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
