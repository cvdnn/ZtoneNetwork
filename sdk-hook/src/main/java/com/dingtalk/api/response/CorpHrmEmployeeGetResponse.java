...
public class CorpHrmEmployeeGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7463848131255815611L;
	...
	public static class SysCustomFieldVpo extends TaobaoObject {
		private static final long serialVersionUID = 4654792294179696235L;
		/**
		 * 确认入职是否必填
		 */
	...
	public static class FieldGroupVpo extends TaobaoObject {
		private static final long serialVersionUID = 8599914773941915425L;
		/**
		 * 字段列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 2825782171687549514L;
		/**
		 * dingOpenErrcode
		 */
