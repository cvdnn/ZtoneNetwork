...
public class OapiAlitripBtripTrainOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2293315649253261257L;
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 3797215472373769781L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 4145923724796727562L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 3755573685273632471L;
		/**
		 * 消费类型
		 */
		@ApiField("category")
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 4256368849199356916L;
		/**
		 * 乘车人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenTrainOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 1476373896784243428L;
		/**
		 * 商旅审批单id
		 */
		@ApiField("apply_id")
