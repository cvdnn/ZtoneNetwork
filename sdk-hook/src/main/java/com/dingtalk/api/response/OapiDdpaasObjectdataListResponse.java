...
public class OapiDdpaasObjectdataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7246845895226934285L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 6649593648767498277L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class ObjectDataInstanceVo extends TaobaoObject {
		private static final long serialVersionUID = 4139784959822553871L;
		/**
		 * 创建记录的用户昵称
		 */
