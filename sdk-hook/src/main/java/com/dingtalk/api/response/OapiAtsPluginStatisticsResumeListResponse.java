...
public class OapiAtsPluginStatisticsResumeListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6845725878498348181L;
	...
	public static class TopResumeStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 3351242464214412577L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 7835779934446467253L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
