...
public class OapiPbpInstanceGroupMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4873951478374957724L;
	...
	public static class PositionVo extends TaobaoObject {
		private static final long serialVersionUID = 4197624447289536573L;
		/**
		 * 成员id，根据类型不同表示不同
		 */
		@ApiField("member_id")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 7625423562433611176L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
