...
public class OapiCrmObjectdataContactQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8543722876954599969L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 4888288944124834514L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 7159152871445313834L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 5477374759935898554L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
