...
public class OapiKacDatavMicroappDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1597583598527385463L;
	...
	public static class MicroAppSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 5666328349763781489L;
		/**
		 * 微应用名
		 */
	...
	public static class MicroAppSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7841843453927347982L;
		/**
		 * 数据列表
		 */
		@ApiListField("data")
