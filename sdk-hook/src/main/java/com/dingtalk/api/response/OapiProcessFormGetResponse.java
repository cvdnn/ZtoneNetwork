...
public class OapiProcessFormGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7625435178538444315L;
	...
	public static class FormComponentStatVo extends TaobaoObject {
		private static final long serialVersionUID = 2424199189161648699L;
		/**
		 * 组件id
		 */
		@ApiField("id")
	...
	public static class LinkageTargetVo extends TaobaoObject {
		private static final long serialVersionUID = 4333578116452123719L;
		/**
		 * 对应目标的行为
		 */
		@ApiField("behavior")
	...
	public static class BehaviorLinkageVo extends TaobaoObject {
		private static final long serialVersionUID = 4561322929376454527L;
		/**
		 * 联动对应的目标
		 */
	...
	public static class FormComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 1788298298389388258L;
		/**
		 * 考勤类型文案
		 */
	...
	public static class FormComponent2Vo extends TaobaoObject {
		private static final long serialVersionUID = 4465374548218823994L;
		/**
		 * 控件类型
		 */
	...
	public static class FormComponent1Vo extends TaobaoObject {
		private static final long serialVersionUID = 6865175264548125178L;
		/**
		 * 子组件
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 2536242278369519666L;
		/**
		 * 子组件
		 */
		@ApiListField("children")
	...
	public static class ProcessTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2228619959257555712L;
		/**
		 * 表单列表
		 */
