...
public class OapiAttendanceApproveDurationCalculateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5651346815755845958L;
	...
	public static class TopDayDurationVo extends TaobaoObject {
		private static final long serialVersionUID = 2316286598746667489L;
		/**
		 * 日期
		 */
		@ApiField("date")
	...
	public static class TopDurationVo extends TaobaoObject {
		private static final long serialVersionUID = 3194488257871581756L;
		/**
		 * 总时长
		 */
		@ApiField("duration")
