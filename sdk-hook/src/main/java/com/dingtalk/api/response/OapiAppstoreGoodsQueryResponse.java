...
public class OapiAppstoreGoodsQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4621246326172772916L;
	...
	public static class OpenGoodsItemCycVo extends TaobaoObject {
		private static final long serialVersionUID = 1843568155992631242L;
		/**
		 * 周期别名
		 */
		@ApiField("alias_name")
	...
	public static class OpenGoodsItemVo extends TaobaoObject {
		private static final long serialVersionUID = 4337899623473698791L;
		/**
		 * 是否试用
		 */
	...
	public static class OpenGoodsVo extends TaobaoObject {
		private static final long serialVersionUID = 8724737878537932986L;
		/**
		 * 规格列表
		 */
