...
public class OapiRobotMessageStatisticsListbyconversationidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7221488921796654321L;
	...
	public static class MsgStatByCIdResVo extends TaobaoObject {
		private static final long serialVersionUID = 8878935227637115359L;
		/**
		 * 群Id
		 */
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 6265587451414119755L;
		/**
		 * 当前页数
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 8319518811926166185L;
		/**
		 * list
		 */
		@ApiListField("list")
