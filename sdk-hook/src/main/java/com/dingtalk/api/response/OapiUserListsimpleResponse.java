...
public class OapiUserListsimpleResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4838773134682114998L;
	...
	public static class ListUserSimpleResponse extends TaobaoObject {
		private static final long serialVersionUID = 8287335473974376859L;
		/**
		 * 用户姓名
		 */
		@ApiField("name")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 1419525364177375846L;
		/**
		 * 是否还有更多的数据
		 */
		@ApiField("has_more")
