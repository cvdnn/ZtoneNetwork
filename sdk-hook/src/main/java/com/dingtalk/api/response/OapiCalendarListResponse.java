...
public class OapiCalendarListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3757984435934883828L;
	...
	public static class Attendees extends TaobaoObject {
		private static final long serialVersionUID = 6695646959192688464L;
		/**
		 * 展示姓名
		 */
	...
	public static class User extends TaobaoObject {
		private static final long serialVersionUID = 6653385361552128272L;
		/**
		 * 展示姓名
		 */
		@ApiField("display_name")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 1437924254695491553L;
		/**
	...
	public static class Items extends TaobaoObject {
		private static final long serialVersionUID = 4639229692931715584L;
		/**
		 * 参与者,考虑性能问题，该字段不向外透出
		 */
	...
	public static class OpenCalendarListResponse extends TaobaoObject {
		private static final long serialVersionUID = 1371241982733619317L;
		/**
		 * 日程的实体
		 */
		@ApiListField("items")
