...
public class OapiAttendanceGetusergroupResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1281875369179286689L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 5268447973455224498L;
		/**
		 * 打卡时间跨几天
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 8786484368896195733L;
		/**
		 * 班次中上下班详情列表
		 */
		@ApiListField("times")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 7548486599582619593L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 3425672778836678515L;
		/**
		 * 班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupFullForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5842126659487328299L;
		/**
		 * 考勤组中的班次列表
		 */
