...
public class OapiAttendanceGroupMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2342852785882654628L;
	...
	public static class TopGroupMemberVo extends TaobaoObject {
		private static final long serialVersionUID = 3713373891578888788L;
		/**
		 * 0表示需要考勤，1表示无需考勤人员
		 */
		@ApiField("atc_flag")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 4318941985592516245L;
		/**
		 * 游标
		 */
		@ApiField("cursor")
