...
public class OapiCrmObjectdataCustomerQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2114522439463885513L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 4269887882777114772L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 8626382874277215229L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 8162666283592594372L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
