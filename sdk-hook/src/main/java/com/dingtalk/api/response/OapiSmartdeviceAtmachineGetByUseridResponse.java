...
public class OapiSmartdeviceAtmachineGetByUseridResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7133864982328538946L;
	...
	public static class MachineVo extends TaobaoObject {
		private static final long serialVersionUID = 3532965823522234967L;
		/**
		 * 考勤机名称
		 */
	...
	public static class MachineInfoResultVo extends TaobaoObject {
		private static final long serialVersionUID = 2677654337862114392L;
		/**
		 * 分页查询中，后页是否还有数据
		 */
		@ApiField("has_more")
