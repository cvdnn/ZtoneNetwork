...
public class OapiAttendanceGetcolumnvalResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2271517912776579391L;
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 1578217585146682296L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 4545253871527775867L;
		/**
		 * 列id
		 */
		@ApiField("id")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1494614582869739727L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6412877224937419583L;
		/**
		 * 列信息与列值数据
		 */
		@ApiListField("column_vals")
