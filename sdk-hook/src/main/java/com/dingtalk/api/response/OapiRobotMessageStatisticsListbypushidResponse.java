...
public class OapiRobotMessageStatisticsListbypushidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4592835265255253646L;
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 4321514263468843262L;
		/**
		 * 当前页数
		 */
	...
	public static class MsgStatByPushIdResVo extends TaobaoObject {
		private static final long serialVersionUID = 3737957591376742549L;
		/**
		 * 群Id
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 1768195781718394796L;
		/**
		 * list
		 */
		@ApiListField("list")
