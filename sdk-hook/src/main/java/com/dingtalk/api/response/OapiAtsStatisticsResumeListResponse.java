...
public class OapiAtsStatisticsResumeListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6283598648368798281L;
	...
	public static class TopResumeStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 1519631119259858466L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 4525421912882178714L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
