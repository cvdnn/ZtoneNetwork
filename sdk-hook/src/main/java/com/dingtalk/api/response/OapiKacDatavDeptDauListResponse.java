...
public class OapiKacDatavDeptDauListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5811616247312848276L;
	...
	public static class DeptDauSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 7891872939993434686L;
		/**
		 * 钉钉app端登录人数
		 */
	...
	public static class DeptDauSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7477412825753443558L;
		/**
		 * 数据列表
		 */
		@ApiListField("data")
