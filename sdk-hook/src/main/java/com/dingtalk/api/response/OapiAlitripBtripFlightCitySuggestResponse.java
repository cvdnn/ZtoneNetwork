...
public class OapiAlitripBtripFlightCitySuggestResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3252514249734385637L;
	...
	public static class CityVo extends TaobaoObject {
		private static final long serialVersionUID = 8423568694842675739L;
		/**
		 * 三字码
		 */
		@ApiField("code")
	...
	public static class SuggestRs extends TaobaoObject {
		private static final long serialVersionUID = 3794469448872698942L;
		/**
		 * 城市列表
		 */
		@ApiListField("cities")
