...
public class OapiWorkbenchShortcutListbypagingResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8727177621548874266L;
	...
	public static class IsvOrgShortcutDTO extends TaobaoObject {
		private static final long serialVersionUID = 8294169432333484844L;
		/**
		 * 业务单号,系统间交互唯一流水号
		 */
		@ApiField("biz_no")
	...
	public static class IsvOrgShortcutListDTO extends TaobaoObject {
		private static final long serialVersionUID = 2749139331646332966L;
		/**
		 * 企业下指定应用已添加快捷方式列表
		 */
