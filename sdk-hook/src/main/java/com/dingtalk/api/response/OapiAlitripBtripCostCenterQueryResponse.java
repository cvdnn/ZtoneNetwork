...
public class OapiAlitripBtripCostCenterQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2256381393889357881L;
	...
	public static class OpenOrgEntityDo extends TaobaoObject {
		private static final long serialVersionUID = 1352826231388715915L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenCostCenterQueryRs extends TaobaoObject {
		private static final long serialVersionUID = 1137457382643734682L;
		/**
		 * 绑定支付宝账号
		 */
		@ApiField("alipay_no")
