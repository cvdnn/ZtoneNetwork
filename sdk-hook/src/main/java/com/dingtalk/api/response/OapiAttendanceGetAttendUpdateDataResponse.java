...
public class OapiAttendanceGetAttendUpdateDataResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1858369111449296874L;
	...
	public static class AtAttendanceResultForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4438657738969111636L;
		/**
		 * 打卡类型 上班还是下班
		 */
		@ApiField("check_type")
	...
	public static class AtApproveForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4777379972346234938L;
		/**
		 * 审批单开始时间
		 */
		@ApiField("begin_time")
	...
	public static class AtAttendanceRecordForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 3732754359177883531L;
		/**
		 * 基本定位精度
		 */
	...
	public static class AtCheckInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 6815955643172155713L;
		/**
		 * 审批单列表
		 */
