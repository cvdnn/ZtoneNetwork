...
public class OapiWorkspaceCorpMemberAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5339814989343266965L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 4791965925927686319L;
		/**
		 * 角色的code
		 */
		@ApiField("code")
	...
	public static class OpenMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 2295264881651399789L;
		/**
		 * 组织id
		 */
		@ApiField("corp_id")
