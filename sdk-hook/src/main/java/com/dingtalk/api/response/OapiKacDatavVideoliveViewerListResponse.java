...
public class OapiKacDatavVideoliveViewerListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4818667494784511722L;
	...
	public static class GroupLiveViewer extends TaobaoObject {
		private static final long serialVersionUID = 2514628557919933327L;
		/**
		 * 观看直播时长（毫秒）
		 */
	...
	public static class GroupLiveViewerPageResult extends TaobaoObject {
		private static final long serialVersionUID = 3243596418484737679L;
		/**
		 * 列表数据项
		 */
		@ApiListField("data")
