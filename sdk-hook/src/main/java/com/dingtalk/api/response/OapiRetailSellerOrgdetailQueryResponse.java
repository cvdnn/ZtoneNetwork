...
public class OapiRetailSellerOrgdetailQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5482486276981129929L;
	...
	public static class ShopEmpDto extends TaobaoObject {
		private static final long serialVersionUID = 4311448435257958793L;
		/**
		 * 主子账号
		 */
		@ApiField("emp_type")
	...
	public static class SellerDto extends TaobaoObject {
		private static final long serialVersionUID = 7348945833128624114L;
		/**
		 * 卖家ID
		 */
		@ApiField("seller_id")
	...
	public static class OrgDto extends TaobaoObject {
		private static final long serialVersionUID = 8389656318485129291L;
		/**
		 * 组织绑定卖家List
		 */
