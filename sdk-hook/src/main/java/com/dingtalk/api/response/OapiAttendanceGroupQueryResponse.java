...
public class OapiAttendanceGroupQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8774233944176855965L;
	...
	public static class TopCycleScheduleItemVO extends TaobaoObject {
		private static final long serialVersionUID = 2252642222599697766L;
		/**
		 * 班次id
		 */
		@ApiField("class_id")
	...
	public static class TopCycleScheduleVO extends TaobaoObject {
		private static final long serialVersionUID = 2526315798676723416L;
		/**
		 * 排班周期名称
		 */
		@ApiField("cycle_name")
	...
	public static class TopSimpleGroupVO extends TaobaoObject {
		private static final long serialVersionUID = 3743448652192555646L;
		/**
		 * 考勤地址
		 */
