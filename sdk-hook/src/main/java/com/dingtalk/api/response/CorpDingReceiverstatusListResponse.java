...
public class CorpDingReceiverstatusListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6476551129843438345L;
	...
	public static class DingReceiverStatusResult extends TaobaoObject {
		private static final long serialVersionUID = 3625445175543778625L;
		/**
		 * 确认状态。0-未确认；1-已确认；
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 6121645627678965234L;
		/**
		 * 错误码
		 */
