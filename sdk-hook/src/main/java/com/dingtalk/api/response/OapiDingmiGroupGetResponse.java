...
public class OapiDingmiGroupGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5493687647658258118L;
	...
	public static class GroupMemberChatData extends TaobaoObject {
		private static final long serialVersionUID = 8275985521422582883L;
		/**
		 * 聊天记录数
		 */
		@ApiField("chat_cnt")
	...
	public static class GroupChatDataResult extends TaobaoObject {
		private static final long serialVersionUID = 6591265564687487145L;
		/**
		 * 是否来自缓存
		 */
		@ApiField("from_cache")
