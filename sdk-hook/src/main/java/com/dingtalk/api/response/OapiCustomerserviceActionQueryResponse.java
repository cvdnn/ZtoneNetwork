...
public class OapiCustomerserviceActionQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6368995385565232512L;
	...
	public static class TicketFieldDto extends TaobaoObject {
		private static final long serialVersionUID = 6167994854324323513L;
		/**
		 * 标签名
		 */
	...
	public static class TicketActionDto extends TaobaoObject {
		private static final long serialVersionUID = 1423853247641778973L;
		/**
		 * 动作表单字段列表
		 */
	...
	public static class PageQueryCursorResult extends TaobaoObject {
		private static final long serialVersionUID = 5443946621826144134L;
		/**
		 * 动作列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 1226724731357167147L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
