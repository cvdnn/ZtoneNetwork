...
public class OapiAttendanceGetleavetimebynamesResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8245991514484658635L;
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3668973926198874732L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 3695367773523533415L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2383336677963964796L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2272159169969325997L;
		/**
		 * 列信息与列值数据
		 */
