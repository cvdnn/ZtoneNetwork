...
public class OapiRhinoOrderBatchGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4655288677327272967L;
	...
	public static class OpenApiProductOrderDto extends TaobaoObject {
		private static final long serialVersionUID = 7377783843775812582L;
		/**
		 * 实际完成时间
		 */
	...
	public static class OpenApiBatchGetProductOrderResult extends TaobaoObject {
		private static final long serialVersionUID = 3277873546375675274L;
		/**
		 * 列表
		 */
		@ApiListField("list")
