...
public class OapiWorkspaceProjectCreateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8567299998538395394L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 3413772119949471589L;
		/**
		 * 角色code
		 */
		@ApiField("code")
	...
	public static class OpenProjectMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 6634354638372954275L;
		/**
		 * 开放组织id
		 */
		@ApiField("corp_id")
	...
	public static class OpenProjectDto extends TaobaoObject {
		private static final long serialVersionUID = 6818142988446147781L;
		/**
		 * 开放组织id
		 */
		@ApiField("corp_id")
