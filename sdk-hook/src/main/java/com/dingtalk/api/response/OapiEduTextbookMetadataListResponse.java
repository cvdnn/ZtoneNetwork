...
public class OapiEduTextbookMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7162647476143222399L;
	...
	public static class TextbookMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 8755838835521241445L;
		/**
		 * 教材id
		 */
		@ApiField("id")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 4385618732279811836L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
