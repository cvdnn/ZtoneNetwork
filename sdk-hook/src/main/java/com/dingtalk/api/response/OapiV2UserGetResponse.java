...
public class OapiV2UserGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6847198558342358491L;
	...
	public static class DeptOrder extends TaobaoObject {
		private static final long serialVersionUID = 3688617135594491192L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class DeptLeader extends TaobaoObject {
		private static final long serialVersionUID = 5214314318818427562L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class UserRole extends TaobaoObject {
		private static final long serialVersionUID = 3631873335888522651L;
		/**
		 * 角色组名称
		 */
		@ApiField("group_name")
	...
	public static class UnionEmpMapVo extends TaobaoObject {
		private static final long serialVersionUID = 7181367828229495329L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
	...
	public static class UnionEmpExt extends TaobaoObject {
		private static final long serialVersionUID = 2328239361999374929L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
	...
	public static class UserGetResponse extends TaobaoObject {
		private static final long serialVersionUID = 5598965659134738282L;
		/**
		 * 是否激活
		 */
		@ApiField("active")
