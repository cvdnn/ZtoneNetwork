...
public class OapiServiceaccountMenuGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5462316188722698759L;
	...
	public static class MenuSubButtonDTO extends TaobaoObject {
		private static final long serialVersionUID = 3277647783647439853L;
		/**
		 * 菜单绑定的key值
		 */
		@ApiField("key")
	...
	public static class MenuButtonDTO extends TaobaoObject {
		private static final long serialVersionUID = 7127633652935428532L;
		/**
		 * 菜单绑定的key值
		 */
		@ApiField("key")
	...
	public static class MenuConfigDTO extends TaobaoObject {
		private static final long serialVersionUID = 2486494833116729219L;
		/**
		 * 菜单按钮列表
		 */
		@ApiListField("button")
