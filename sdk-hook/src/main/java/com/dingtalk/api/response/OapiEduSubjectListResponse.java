...
public class OapiEduSubjectListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2754521899825768767L;
	...
	public static class SubjectInstanceDTO extends TaobaoObject {
		private static final long serialVersionUID = 8118455431117432748L;
		/**
		 * 学段编码
		 */
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 6547312697811983679L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
