...
public class OapiCrmObjectmetaContactDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6857851624688267145L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 2897174569935586723L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 5282629115668977328L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 7353539254258485486L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 5244396636131648487L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 6894953937499926982L;
		/**
		 * 是否自定义对象
		 */
		@ApiField("customized")
