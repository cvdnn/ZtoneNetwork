...
public class OapiDingpayOrderSyncstatusResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3727479366943145153L;
	...
	public static class Orders extends TaobaoObject {
		private static final long serialVersionUID = 1484479233526371829L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class OrderSyncStatusOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 6232191155389548633L;
		/**
		 * orders
		 */
		@ApiListField("orders")
