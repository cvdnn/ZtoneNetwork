...
public class OapiEduCourseDetaildataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2591625584777664533L;
	...
	public static class CourseDetailDataDTO extends TaobaoObject {
		private static final long serialVersionUID = 5313838446281782294L;
		/**
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 1141811963625915674L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
