...
public class OapiAppstoreInternalUnfinishedorderListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4539222138719988484L;
	...
	public static class InAppGoodsOrderVO extends TaobaoObject {
		private static final long serialVersionUID = 7513142196269865869L;
		/**
		 * 订单号
		 */
	...
	public static class PageModel extends TaobaoObject {
		private static final long serialVersionUID = 1468821599149184758L;
		/**
		 * 订单信息列表
		 */
		@ApiListField("items")
