...
public class OapiAtsStatisticsJobListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3719457866881734856L;
	...
	public static class TopJobStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 5164922847451658253L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 2599663436929269592L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
