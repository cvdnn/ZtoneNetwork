...
public class OapiCateringCooplistGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7877387246761115864L;
	...
	public static class Mealitemlist extends TaobaoObject {
		private static final long serialVersionUID = 1188188742429686199L;
		/**
		 * 送达时间 HH:mm
		 */
	...
	public static class MealSettingList extends TaobaoObject {
		private static final long serialVersionUID = 7214182845356927572L;
		/**
		 * 缩略地址，可为空
		 */
		@ApiField("address")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 7448995284729528879L;
		/**
		 * 是否有下一项数据
		 */
		@ApiField("has_next")
