...
public class OapiEduPeriodMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5352677863448586782L;
	...
	public static class PeriodMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 4775237386261872788L;
		/**
		 * 区域编码
		 */
		@ApiField("area_code")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7651622164263627415L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
