...
public class OapiProcessWorkrecordTaskQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2486624222675237896L;
	...
	public static class FormItemVo extends TaobaoObject {
		private static final long serialVersionUID = 6347311935592166762L;
		/**
		 * 内容
		 */
		@ApiField("content")
	...
	public static class WorkRecordVo extends TaobaoObject {
		private static final long serialVersionUID = 6845754687259298516L;
		/**
		 * 表单列表
		 */
		@ApiListField("forms")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 3512874628426182946L;
		/**
		 * 是否有更多数据
		 */
		@ApiField("has_more")
