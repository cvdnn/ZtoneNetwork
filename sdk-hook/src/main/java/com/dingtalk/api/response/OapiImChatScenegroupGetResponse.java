...
public class OapiImChatScenegroupGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1638713195787248642L;
	...
	public static class ManagementOptions extends TaobaoObject {
		private static final long serialVersionUID = 7222793872845854763L;
		/**
		 * 群禁言，0-默认，不禁言，1-全员禁言
		 */
	...
	public static class DecorationGroupQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 6765245785147771157L;
		/**
		 * 入群链接（需特殊申请才返回）
		 */
		@ApiField("group_url")
