...
public class OapiReportTemplateGetbynameResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5124194491349581547L;
	...
	public static class DefaultReceivers extends TaobaoObject {
		private static final long serialVersionUID = 8726873565416417158L;
		/**
		 * 默认接收人名称
		 */
		@ApiField("user_name")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 4656645888954999621L;
		/**
		 * 模板字段名称
		 */
		@ApiField("field_name")
	...
	public static class BaseConversationVo extends TaobaoObject {
		private static final long serialVersionUID = 8422477115455664435L;
		/**
		 * 默认接收群id
		 */
	...
	public static class ReportTemplateResponseVo extends TaobaoObject {
		private static final long serialVersionUID = 6756193165316136436L;
		/**
		 * 默认接收群
		 */
