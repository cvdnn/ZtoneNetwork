...
public class OapiCrmObjectmetaDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8652726543542716911L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 3373414594451612319L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 5369862773148236261L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 8565469612855735422L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 5459757124682276448L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 2838828791579953348L;
		/**
		 * 是否自定义对象
		 */
		@ApiField("customized")
