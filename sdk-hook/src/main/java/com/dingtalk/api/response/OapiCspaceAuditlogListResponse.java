...
public class OapiCspaceAuditlogListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7158736899446852236L;
	...
	public static class AuditLogVO extends TaobaoObject {
		private static final long serialVersionUID = 5755337818842339638L;
		/**
		 * 操作类型
		 */
		@ApiField("action")
	...
	public static class ListAuditLogResult extends TaobaoObject {
		private static final long serialVersionUID = 1387365361768724641L;
		/**
		 * 记录列表
		 */
		@ApiListField("list")
