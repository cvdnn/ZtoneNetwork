...
public class OapiWorkspaceUpdateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4654177462729399753L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 6851442195874113391L;
		/**
		 * 角色code
		 */
		@ApiField("code")
	...
	public static class OpenMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 7661486521134576717L;
		/**
		 * 项目corpid
		 */
		@ApiField("corp_id")
	...
	public static class OpenWorkspaceDto extends TaobaoObject {
		private static final long serialVersionUID = 2172997411596527652L;
		/**
		 * 创建时间
		 */
