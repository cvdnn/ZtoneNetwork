...
public class OapiAttendanceClassGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8829679559978193684L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 4423323117639636958L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class AtClassSettingForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1476222347399212188L;
		/**
		 * classId
		 */
		@ApiField("class_id")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 4465267346787493412L;
		/**
		 * 时间段列表
		 */
		@ApiListField("times")
	...
	public static class AtClassForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2382438562668452256L;
		/**
		 * 考勤组班次配置
		 */
