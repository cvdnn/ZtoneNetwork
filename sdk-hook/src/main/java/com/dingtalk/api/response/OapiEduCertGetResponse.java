...
public class OapiEduCertGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3791616343377674995L;
	...
	public static class Certdata extends TaobaoObject {
		private static final long serialVersionUID = 7226292723615947812L;
		/**
	...
	public static class OpenPracticalTaskData extends TaobaoObject {
		private static final long serialVersionUID = 3734543248342483512L;
		/**
		 * true表示完成，false表示未完成
		 */
		@ApiField("finish")
	...
	public static class OpenQueryCertResponse extends TaobaoObject {
		private static final long serialVersionUID = 6237317114421164262L;
		/**
		 * 认证明细
		 */
