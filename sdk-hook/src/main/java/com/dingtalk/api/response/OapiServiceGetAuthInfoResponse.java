...
public class OapiServiceGetAuthInfoResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6435728189491672464L;
	...
	public static class Agent extends TaobaoObject {
		private static final long serialVersionUID = 4289236745615758797L;
		/**
		 * admin_list
		 */
	...
	public static class AuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 3543349827551323841L;
		/**
		 * agent
		 */
		@ApiListField("agent")
	...
	public static class AuthUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 6812754556222235589L;
		/**
		 * userId
		 */
		@ApiField("userId")
	...
	public static class AuthCorpInfo extends TaobaoObject {
		private static final long serialVersionUID = 5234174774618625845L;
		/**
		 * auth_channel
		 */
	...
	public static class Channelagent extends TaobaoObject {
		private static final long serialVersionUID = 3579997989391758169L;
		/**
		 * agent_name
		 */
		@ApiField("agent_name")
	...
	public static class ChannelAuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 1864329842688567288L;
		/**
		 * channelAgent
		 */
