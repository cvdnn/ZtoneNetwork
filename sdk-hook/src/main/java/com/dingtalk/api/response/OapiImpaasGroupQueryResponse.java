...
public class OapiImpaasGroupQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5687533567589691239L;
	...
	public static class BaseGroupMemberInfo extends TaobaoObject {
		private static final long serialVersionUID = 6752437973477399125L;
		/**
		 * 群主ID，类型由type字段决定
		 */
		@ApiField("id")
	...
	public static class GroupInfo extends TaobaoObject {
		private static final long serialVersionUID = 6217124661514414712L;
		/**
		 * 群ID
		 */
		@ApiField("chatid")
