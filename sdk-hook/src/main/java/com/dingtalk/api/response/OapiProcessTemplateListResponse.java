...
public class OapiProcessTemplateListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7591819626371189261L;
	...
	public static class Templatelist extends TaobaoObject {
		private static final long serialVersionUID = 5771837378535787149L;
		/**
		 * 是否可升级，加入收款账户组件
		 */
	...
	public static class CorpTemplateVo extends TaobaoObject {
		private static final long serialVersionUID = 7872811977696155947L;
		/**
		 * 下次调用时的offset入参
		 */
