...
public class CorpRoleListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2781826343992642151L;
	...
	public static class Roles extends TaobaoObject {
		private static final long serialVersionUID = 7689426766559946877L;
		/**
		 * 角色ID
		 */
		@ApiField("id")
	...
	public static class RoleGroups extends TaobaoObject {
		private static final long serialVersionUID = 6466551878818616389L;
		/**
		 * 角色分组名称
		 */
		@ApiField("group_name")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 1291643683819812867L;
		/**
		 * 分页是否还有数据
		 */
		@ApiField("has_more")
