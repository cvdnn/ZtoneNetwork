...
public class OapiKacDatavDeptVideoconfListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4458222274952834361L;
	...
	public static class McsDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 4897682659149252756L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class McsDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7343728669451995584L;
		/**
		 * data
		 */
		@ApiListField("data")
