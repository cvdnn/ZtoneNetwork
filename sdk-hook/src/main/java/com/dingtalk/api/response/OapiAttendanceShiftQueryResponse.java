...
public class OapiAttendanceShiftQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4691982149135285433L;
	...
	public static class TopShiftSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 8281178585914656232L;
		/**
		 * 该班次对应的出勤天数
		 */
	...
	public static class TopPunchVo extends TaobaoObject {
		private static final long serialVersionUID = 2267896697279783196L;
		/**
		 * 旷工早退迟到的时长
		 */
	...
	public static class TopRestVo extends TaobaoObject {
		private static final long serialVersionUID = 2558475863347147311L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class TopSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 8667243761714556828L;
		/**
		 * id
		 */
		@ApiField("id")
	...
	public static class TopShiftVo extends TaobaoObject {
		private static final long serialVersionUID = 4532133151893643416L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
