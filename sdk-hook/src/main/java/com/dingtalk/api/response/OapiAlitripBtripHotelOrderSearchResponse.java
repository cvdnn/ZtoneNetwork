...
public class OapiAlitripBtripHotelOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3299479934223926364L;
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 6169988819951662197L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 4119562147377381247L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 7646355821357729968L;
		/**
		 * 交易类型
		 */
		@ApiField("category")
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 5398174479891611356L;
		/**
		 * 入住人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenHotelOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 3372439244275295962L;
		/**
		 * 商旅申请单id
		 */
		@ApiField("apply_id")
