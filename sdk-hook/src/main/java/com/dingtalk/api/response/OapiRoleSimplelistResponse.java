...
public class OapiRoleSimplelistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3757436227167874496L;
	...
	public static class OrgDeptVo extends TaobaoObject {
		private static final long serialVersionUID = 8558213593353744983L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class OpenEmpSimple extends TaobaoObject {
		private static final long serialVersionUID = 5494635145179494254L;
		/**
		 * 管理范围
		 */
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 8322318791353567826L;
		/**
		 * 后面是否还有数据
		 */
		@ApiField("hasMore")
